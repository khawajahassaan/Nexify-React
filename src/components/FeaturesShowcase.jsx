...
export default function FeaturesShowcase() {
    ...
    return (
        ...
        <section className="feature-showcase relative overflow-hidden z-0">
            ...
            <div className="showcase-row">
                <div className="showcase-text">
                    ...
                    <ul className="feature-bullet-list">
                        <li><i className="fa-solid fa-check text-[#5b4fcf]"></i> 60fps performance guarantee</li>
                        <li><i className="fa-solid fa-check text-[#5b4fcf]"></i> Spring physics integration</li>
                        <li><i className="fa-solid fa-check text-[#5b4fcf]"></i> Micro-interactions included</li>
                    </ul>
                </div>
                <div className="showcase-visual visual-purple">
                    <div className="mock-window">
                        ...
                        <div className="mock-body">
                            ...
                            <div className="mock-skeleton pulse-anim w-[70%]"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="showcase-row reverse">
                <div className="showcase-text">
                    ...
                    <ul className="feature-bullet-list">
                        <li><i className="fa-solid fa-check text-[#10b981]"></i> Accessible by default (WCAG 2.1)</li>
                        <li><i className="fa-solid fa-check text-[#10b981]"></i> Highly customizable tokens</li>
                        <li><i className="fa-solid fa-check text-[#10b981]"></i> Dark mode ready</li>
                    </ul>
                </div>
