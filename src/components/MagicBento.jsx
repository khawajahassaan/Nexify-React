...
const cardData = [
  ...
  },
  {
    color: 'rgba(255, 255, 255, 0.03)',
    title: 'Accessible',
    description: 'WCAG 2.1 compliant out of the box. Keyboard navigation and screen-reader ready.',
    label: 'Acc',
    icon: '♿'
  },
  {
    ...
    description: 'Stop reinventing the wheel. Use our 100+ beautifully crafted, plug-and-play sections.',
    label: 'Components',
    icon: '🧩'
  }
];
          ...
          if (enableStars) {
            return (
              ...
              >
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[120px] opacity-[0.12] pointer-events-none select-none z-0">
                  {card.icon}
                </div>
